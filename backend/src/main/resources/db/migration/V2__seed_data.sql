...
VALUES
    -- Phở Thìn Lò Đúc
    ('a1000001-0000-0000-0000-000000000001', 'f09f2191-2088-4087-a52f-c181152af535',
     'https://res.cloudinary.com/drity7uew/image/upload/v1780146732/phoThinLoDuc_03_cbbbko.jpg', 0),
    ('a1000001-0000-0000-0000-000000000002', 'f09f2191-2088-4087-a52f-c181152af535',
     'https://res.cloudinary.com/drity7uew/image/upload/v1780146732/phoThinLoDuc_01_cgyioy.jpg', 1),
    ('a1000001-0000-0000-0000-000000000003', 'f09f2191-2088-4087-a52f-c181152af535',
     'https://res.cloudinary.com/drity7uew/image/upload/v1780146732/phoThinLoDuc_02_ih5ios.jpg', 2),

    -- Bún Chả Hương Liên
    ('a2000002-0000-0000-0000-000000000001', '62689fdc-2062-4964-b429-e64db59d07b1',
     'https://res.cloudinary.com/drity7uew/image/upload/v1780147137/bunChaHuongLien_01_m5angm.jpg', 0),
    ('a2000002-0000-0000-0000-000000000002', '62689fdc-2062-4964-b429-e64db59d07b1',
     'https://res.cloudinary.com/drity7uew/image/upload/v1780147137/bunChaHuongLien_02_jddivx.jpg', 1),
    ('a2000002-0000-0000-0000-000000000003', '62689fdc-2062-4964-b429-e64db59d07b1',
     'https://res.cloudinary.com/drity7uew/image/upload/v1780147137/bunChaHuongLien_03_y1xsig.jpg', 2),

    -- Pizza Zio Bello
    ('a3000003-0000-0000-0000-000000000001', '8589221b-9ebe-430d-a475-65a1f2ef5825',
     'https://res.cloudinary.com/drity7uew/image/upload/v1780147399/pizzaZioBello_01_ybapnb.jpg', 0),
    ('a3000003-0000-0000-0000-000000000002', '8589221b-9ebe-430d-a475-65a1f2ef5825',
     'https://res.cloudinary.com/drity7uew/image/upload/v1780147399/pizzaZioBello_02_x4kmmx.jpg', 1),
    ('a3000003-0000-0000-0000-000000000003', '8589221b-9ebe-430d-a475-65a1f2ef5825',
     'https://res.cloudinary.com/drity7uew/image/upload/v1780147399/pizzaZioBello_03_xzrn03.jpg', 2);
...
VALUES
    ...
    ('e65caae9-3643-417b-8972-76b5856a81a7',
     ...
     7,
     22),
    ('3f8f6a9d-7b2e-4d4f-9e61-5f3e8a2c7b91',
     '62689fdc-2062-4964-b429-e64db59d07b1',
     8,
     7,
     22),
    -- Pizza Sài Gòn House
    ('a12d4f87-9c3b-4e6d-b1f2-8a7c5d9e3f41',
     '8589221b-9ebe-430d-a475-65a1f2ef5825',
     2,
     6,
     12),
...
-- 11. DISH_IMAGES
-- =========================================================================
INSERT INTO dish_images (id, dish_id, image_url, display_order)
VALUES
    -- Phở Thìn
...
VALUES ('0ab2ddfb-a719-48a7-86dc-46dca0959f5f',
        '11b65227-8ea6-44c4-b3bd-1f76439aa67e',
        0.00,
        'VND'),
...
INSERT INTO order_items (id,
                         ...
                         unit_price_amount,
                         unit_price_currency)
VALUES ('f8b20c6e-a19e-4bef-90e8-85e9eaa03181',
        '907c3abb-4cca-49de-ae95-d534353797c0',
        '04c815b5-9ec5-424d-a6fe-1bf3779687f0',
        1,
        85000.00,
...
VALUES ('609ac09c-57b3-4ac2-8454-ea016873985d',
        '907c3abb-4cca-49de-ae95-d534353797c0',
        'PENDING',
        N'Đơn hàng được tạo',
        '2025-01-05 07:30:00'),
...
INSERT INTO delivery_tasks (id,
                            ...
                            picked_up_at,
                            delivered_at)
VALUES ('9dd06806-8735-49a9-9c76-823f8ea235ce',
        '907c3abb-4cca-49de-ae95-d534353797c0',
        '11b65227-8ea6-44c4-b3bd-1f76439aa67e',
        'DELIVERED',
        '2025-01-05 07:49:00',
...
-- =========================================================================
INSERT INTO driver_order_requests (id,
                                   order_id,
                                   driver_id,
                                   status,
                                   pinged_at,
                                   expires_at)
VALUES ('ba517e52-d4a6-445b-bb73-ea63084e6d1d',
        '907c3abb-4cca-49de-ae95-d534353797c0',
        '4d9078cb-dcf6-475c-b043-ef1e3475fb6f',
        'REJECTED',
        '2025-01-05 07:45:00',
...
INSERT INTO dish_reviews (id,
                          ...
                          comment,
                          created_at)
VALUES ('c86e721a-9e36-43a9-8532-c67470466856',
        '04c815b5-9ec5-424d-a6fe-1bf3779687f0',
        '8774fcd7-84c1-4eda-afbf-7cc56902c662',
        '907c3abb-4cca-49de-ae95-d534353797c0',
        5,
...
-- =========================================================================
INSERT INTO wallet_transactions (id,
                                 wallet_id,
                                 amount,
                                 type,
                                 reference_order_id,
                                 created_at)
VALUES ('59b7a0dd-28cd-4850-952e-196502155b8f',
